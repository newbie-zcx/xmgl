...
$.extend(true,myflow.config.tools.states,{
	start : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : '/static/assets/module/myflow/img/16/start_event_empty.png',width : 16, height:16},
				props : {
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : '/static/assets/module/myflow/img/16/end_event_terminate.png',width : 16, height:16},
				props : {
			...
			'end-cancel' : {type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : '/static/assets/module/myflow/img/16/end_event_cancel.png',width : 16, height:16},
				props : {
			...
			'end-error' : {type : 'end-error',
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : '/static/assets/module/myflow/img/16/end_event_error.png',width : 16, height:16},
				props : {
			...
			state : {type : 'state',
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : '/static/assets/module/myflow/img/16/task_empty.png',width : 16, height:16},
				props : {
			...
			fork : {type : 'fork',
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : '/static/assets/module/myflow/img/16/gateway_parallel.png',width :16, height:16},
				props : {
